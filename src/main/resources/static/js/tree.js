...
function createTree(arrName, startNode, openNode) {
	...
	if (nodes.length > 0) {
		...
		if (openNode != -1 || openNode != null) setOpenNodes(openNode);
	
		if (startNode != -1) {
			var nodeValues = nodes[getArrayId(startNode)].split("|");
			//document.write("<a href=\"" + nodeValues[3] + "\" onmouseover=\"window.status='" + nodeValues[2] + "';return true;\" onmouseout=\"window.status=' ';return true;\"><img src=\"images/img/folderopen.gif\" align=\"absbottom\" alt=\"\" />" + nodeValues[2] + "</a><br />");
			document.write("<img src=\"images/img/folderopen.gif\" align=\"absbottom\" alt=\"\" />" + nodeValues[2] + "<br />");
		} else document.write("<img src=\"images/img/base.gif\" align=\"absbottom\" alt=\"\" />System Function<br />");
	...
	for (var i = 0; i < nodes.length; i++) {
		...
		if (nodeValues[1] == parentNode) {
			...
			if (hcn) {
				...
				if (ls) document.write("<img src=\"images/img/joinbottom.gif\" align=\"absbottom\" alt=\"\" />");
				else document.write("<img src=\"images/img/join.gif\" align=\"absbottom\" alt=\"\" />");
			}

			
			// Write out folder & page icons
			if (hcn) {
				document.write("<img id=\"icon" + nodeValues[0] + "\" src=\"images/img/folder")
